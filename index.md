...
A low-latency, WebRTC baby monitor and open source smart speaker ([Mycroft](https://mycroft.ai/about-mycroft/)) built on a Raspberry Pi. The baby monitor allows any browser on the local wifi network to connect to a high quality, real time media stream from the Pi's infrared camera and USB connected condenser microphone. This project was motivate by the birth of our first child and was a blast to put together. Check out [this blog post for more information]() or you can jump to the [install instructions on GitHub](https://github.com/jhthompson12/BabySpiCroft-Setup-Files).
